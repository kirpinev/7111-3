...
function renderLanding() {
  ...
  if (!sessionStorage.getItem('landingViewed')) {
    sendAnalyticsEvent('7111_page_view_kk_var3', '7111_page_view_kk_var3');
      ...
      <div class="landing__content">
        ...
        <div class="features">
          <div class="feature">
            ...
            <div class="feature__desc">бесплатно в 1-й&nbsp;месяц, далее 2&nbsp;990&nbsp;₽ в&nbsp;год</div>
          </div>
  ...
  document.getElementById('sendBtn').onclick = () => {
    window.location.href = 'alfabank://sdui_screen?screenName=InvestmentLongread&fromCurrent=true&shouldUseBottomSafeArea=true&endpoint=v1/invest-main-screen-view/investment-longread/93820%3flocation=AM%26campaignCode=GH';
  };
}
...
function renderPlaceholder() {
  ...
  if (!sessionStorage.getItem('endPageViewed')) {
    sendAnalyticsEvent('7111_end_page_view_kk_var3', '7111_end_page_view_kk_var3');
